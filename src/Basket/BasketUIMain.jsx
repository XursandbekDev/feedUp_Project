...
function Basket() {
    const { data: basketItems, error, isLoading, isSuccess } = useGetCartItemsQuery();
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <h1 className="text-3xl font-semibold text-gray-800 mb-6">Savatcha</h1>
                    ...
                    {basketItems && basketItems.map((item) => (
                        ...
                        >
                            ...
                            <div className="p-4">
                                ...
                                <p className="text-lg text-blue-600 font-semibold mb-2">
                                    Sanoat bo'limi: {item.food.category.name}
                                </p>
